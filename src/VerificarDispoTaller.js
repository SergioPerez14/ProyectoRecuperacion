...
import './App.css';
import Form23 from './Form23.js';
import Table12 from './Table12.js';
  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Verificar Disponibilidad de los Talleres</h3></header>
			<br />
			<br />
	        <Form23 onChange={fields => this.onChange(fields)} />
			<br />
			<p className="App-intro5"> La busqueda finalizo correctamente </p>
			<br />
			<RaisedButton label="Ver Estado de los Talleres" onClick={this.handleOpen} primary style='' />
		        <Dialog
		          title="Talleres"
		          actions={actions}
		          modal={false}
		        ...
		        >
		          <Table12 />
		          <p align="center">El taller R/G esta disponible</p>
		        </Dialog>
		    <br /><br /><br />
	      </div>
      	</MuiThemeProvider>
