...
import Table14 from './Table14.js';
  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Realizar Presupuesto</h3></header>
			<br />
			<p className="App-intro5"> Datos del Presupuesto </p>
			<br />
	        <Form25 onChange={fields => this.onChange(fields)} />
			<br />

		    <br />
			<RaisedButton label="Ver tabla de presupuesto" onClick={this.handleOpen} primary style='' />
		        <Dialog
		          title="Presupuesto: 896876"
		          actions={actions}
		          modal={false}
		        ...
		        >
		          <Table14 />
		          <p className="App-intro6"> Subtotal: 80442.00 </p>
		          <p className="App-intro6">  16% IVA: 12870.72</p>
		          <p className="App-intro6">    Envio:  1200.00</p>
		          <p className="App-intro6">    Total: 94512.72 </p>
		        </Dialog>
		    <br /><br />
	      </div>
      	</MuiThemeProvider>
