  ...
  render() {
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Busqueda de Usuarios</h3></header>
			<br />

			<p className="App-intro2" align="left"><b>Ingrese el nombre del usuario</b></p>
			<br />
	        <Form6 onChange={fields => this.onChange(fields)} />
	        	<Table />
	        <br /><br /><br /><br />
	      </div>
      	</MuiThemeProvider>
