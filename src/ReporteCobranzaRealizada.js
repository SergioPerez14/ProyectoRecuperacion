  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Generar Reporte de Cobranzas Realizadas</h3></header>
			<br />
	        <Form30 onChange={fields => this.onChange(fields)} />
			    <Table20 />
			<br />
