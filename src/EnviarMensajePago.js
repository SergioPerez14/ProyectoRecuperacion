...
import './App.css';
import Form35 from './Form35.js';
import Table24 from './Table24.js';
  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Enviar Mensaje de Pago</h3></header>
			<br />
	        <Form35 onChange={fields => this.onChange(fields)} />

			<br />
		    <p className="App-intro5"> Resultados de la busqueda </p>
		        <br /><br />
		        <Table24 />
		        <br /><br />
		        <RaisedButton label="Enviar Alerta" onClick={this.handleOpen} primary style='' />
		        <Dialog
		          title="Enviando Mensaje de Pago Inmediato"
		          actions={actions}
		          modal={false}
