  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Consultar Estado de la Venta</h3></header>
			<br />
			<br />
	        <Form12 onChange={fields => this.onChange(fields)} />
			<br /><br />
			
			<p align="center"><h3>Total de la Venta: $ 39.00</h3> </p>
			<RaisedButton label="Ver detalles de la Venta" onClick={this.handleOpen} primary style='' />
		        <Dialog
