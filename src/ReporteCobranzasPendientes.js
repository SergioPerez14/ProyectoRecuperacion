  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Generar Reporte de Cobranzas Pendientes</h3></header>
			<br />
	        <Form31 onChange={fields => this.onChange(fields)} />
			    <Table21 />
			<br />
