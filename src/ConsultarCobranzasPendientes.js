...
import './App.css';
import Form33 from './Form33.js';
import Table22 from './Table22.js';
  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Consultar Cobranzas Pendientes</h3></header>
			<br />
	        <Form33 onChange={fields => this.onChange(fields)} />
