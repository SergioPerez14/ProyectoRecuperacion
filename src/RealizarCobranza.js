  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Realizar Cobranza</h3></header>
			<br />
	        <Form32 onChange={fields => this.onChange(fields)} />

			<br />
		    <p className="App-intro5"> Se ha realizado la cobranza con exito </p>
		        <br /><br /><br />
	      </div>
      	</MuiThemeProvider>
    );
