  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Eliminar Presupuesto</h3></header>
			<br />
	        <Form27 onChange={fields => this.onChange(fields)} />
			<br /><br />
		    <RaisedButton label="Ver Presupuesto" onClick={this.handleOpen} primary style='' />
		        <Dialog
