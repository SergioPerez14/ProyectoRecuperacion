...
import './App.css';
import Form24 from './Form24.js';
import Table13 from './Table13.js';
  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Asignacion de Tareas al Taller</h3></header>
			<br />
			<p className="App-intro5"> Seleccione un Taller </p>
			<br />
	        <Form24 onChange={fields => this.onChange(fields)} />
			<br />

			<RaisedButton label="Asignar Servicio a Taller" onClick={this.handleOpen} primary style='' />
		        <Dialog
		          title="Talleres"
		          actions={actions}
		          modal={false}
		    ...
		    <br /><br />
		    	<p className="App-intro5"> La asignacion de servicios finalizo correctamente </p>
			<br /><br />
	      </div>
      	</MuiThemeProvider>
    );
