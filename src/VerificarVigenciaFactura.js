  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Verificar Vigencia de Factura</h3></header>
			<br />
			<br />
	        <Form16 onChange={fields => this.onChange(fields)} />
			<br /><br />
			
			<p align="center"><h3>Tu factura vence el 21-11-2017</h3> </p>
			<RaisedButton label="Ver detalles de la Factura" disabled={true} onClick={this.handleOpen} primary style='' />
		        <Dialog
			...
			<p align="center"><h4>*Se ha bloqueado el acceso a la factura debido a que esta vencida</h4> </p>
		    <br /><br /><br />
	      </div>
      	</MuiThemeProvider>
    );
