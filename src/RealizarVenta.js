  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Realizar Venta</h3></header>
			<br />
			<br />
	        <Form11 onChange={fields => this.onChange(fields)} />
	        	<Table3 />
	        <br /><br /><br />
				<p className="App-intro3"><h3> Total de la Venta: $ 39.00 </h3></p>
				<br /><br />
			<RaisedButton label="Proceder con la Venta" onClick={this.handleOpen} primary style='' />
		        <Dialog
