  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Realizar Orden de Servicio</h3></header>
			<br />
			<br />
	        <Form17 onChange={fields => this.onChange(fields)} />
			<br /><br />
			
			<p align="center"><h3>Tu orden de servicio se proceso correctamente</h3> </p>
		    <br /><br /><br />
	      </div>
      	</MuiThemeProvider>
    );
