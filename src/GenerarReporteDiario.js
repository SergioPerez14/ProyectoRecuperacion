  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Generar Reporte Diario</h3></header>
			<br />
	        <Form28 onChange={fields => this.onChange(fields)} />
			<br />
				<p className="App-intro7"> Total de Presupuestos realizados en el dia </p>
			    <Table18 />
			<br />
