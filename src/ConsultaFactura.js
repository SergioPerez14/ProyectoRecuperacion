  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Consultar Factura</h3></header>
			<br />
			<br />
	        <Form15 onChange={fields => this.onChange(fields)} />
			<br /><br />
			
			<p align="center"><h3>Tu Factura</h3> </p>
