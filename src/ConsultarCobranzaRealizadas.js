...
import './App.css';
import Form34 from './Form34.js';
import Table23 from './Table23.js';
  ...
  render() {
    ...
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Consultar Cobranzas Realizadas</h3></header>
			<br />
	        <Form34 onChange={fields => this.onChange(fields)} />
