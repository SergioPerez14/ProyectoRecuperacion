  ...
  render() {
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Alta de Productos</h3></header>
			<br />

			<p className="App-intro2" align="left"><b>Ingrese los datos del producto</b></p>
			<br />
	        <Form7 onChange={fields => this.onChange(fields)} />
