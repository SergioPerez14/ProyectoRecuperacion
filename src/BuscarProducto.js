  ...
  render() {
    return (
	      ...
	      <div className="App">
	        ...
	        <header className="App-header"><h3>Busqueda de Productos</h3></header>
			<br />

			<p className="App-intro2" align="left"><b>Ingrese el codigo o clave del producto</b></p>
			<br />
	        <Form10 onChange={fields => this.onChange(fields)} />
	        	<Table2 />
	        <br /><br /><br /><br />
	      </div>
      	</MuiThemeProvider>
